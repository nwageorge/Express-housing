...
export const FinancialHero = ({
  ...
  // Inline style for the grid background
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-1/2">
          <motion.h1
            className="text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl text-foreground"
        ...
        {/* Right: Card Images */}
        <motion.div
          className="relative lg:w-1/2 h-[400px] w-full flex items-center justify-center"
