...
const testimonials = [
  {
    id: 1,
    quote: "Adltrack helped us find the perfect caregiver for my mother. The care quality is exceptional and we finally have peace of mind.",
    name: "Sarah M.",
    role: "Daughter",
  ...
  {
    id: 2,
    quote: "Professional, compassionate, and reliable. Our family couldn't be happier with the service. Highly recommend!",
    name: "James R.",
    role: "Son",
  ...
  {
    id: 3,
    quote: "After my surgery, Adltrack provided excellent recovery care. I'm back on my feet thanks to their amazing caregivers.",
    name: "Michael K.",
    role: "Patient",
  ...
  {
    id: 4,
    quote: "Finding quality infant care was stressful until we found Adltrack. Now we have complete peace of mind with our baby.",
    name: "Lisa P.",
    role: "Mother",
    company: "Newark, NJ",
  ...
  {
    id: 5,
    quote: "The caregivers are so patient with my father. They treat him like family. This service changed our lives.",
    name: "Emily T.",
    role: "Daughter",
    company: "Philadelphia, PA",
