...
// Agency Card Component - Matching Reference Design
...
// Testimonials Component with Marquee
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              ...
              <motion.div
                whileHover={{ y: -8 }}
                className="rounded-3xl overflow-hidden shadow-2xl mt-8"
              >
                <img
  ...
  const handleBooking = async (e) => {
    ...
    try {
      ...
      await axios.post(`${API}/bookings`, {
        ...bookingData,
        agency_id: id,
        patient_age: bookingData.patient_age ? parseInt(bookingData.patient_age) : null,
      }, {
                ...
                <div className="p-8">
                  <div className="flex flex-wrap items-center gap-6 mb-6">
                    ...
                    <div className="flex items-center gap-2 text-gray-500">
                      ...
                      <span>{agency.experience_years} years experience</span>
                    </div>
                  </div>

                  <div className="mb-6">
                    <h2 className="text-xl font-bold text-gray-900 mb-3">About</h2>
                    <p className="text-gray-600 leading-relaxed">{agency.bio}</p>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {agency.certifications?.map((c, i) => (
                        <span key={i} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium flex items-center gap-1">
      ...
      <div className="pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-8">
            ...
            <p className="text-gray-500">Manage your care bookings and account</p>
          </div>
                  ...
                  <div key={booking.id} className="p-6 hover:bg-amber-50/50 transition">
                    <div className="flex items-start justify-between">
                      <div className="flex gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900">
                            {booking.agency?.name || "Care Agency"}
                          </h3>
                      ...
                      <div className="text-right">
                        ...
                        <p className="mt-2 font-semibold text-gray-900">${booking.total_price}/hr</p>
                      </div>
                    </div>
                  </div>
                ))}
    ...
    <GlowBackground variant="auth" className="flex items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-gray-500 mb-8">
          Your care consultation has been successfully booked. The agency will contact you shortly to confirm details.
        </p>
...
const FAQPage = () => {
  ...
  const faqs = [
    {
      question: "What types of in-home care services do you offer?",
      answer: "We connect families with caregivers offering a wide range of services including elderly care, pediatric care, post-surgery recovery, chronic disease management, dementia/Alzheimer's care, 24-hour care, respite care, and skilled nursing services."
    },
    {
      question: "How are caregivers vetted?",
      answer: "All caregivers on our platform undergo comprehensive background checks, credential verification, and reference checks. We verify licenses, certifications, and work history to ensure only qualified professionals are listed."
    },
    {
      question: "How much does in-home care cost?",
      answer: "Costs vary based on the type of care needed, location, and caregiver experience. Our rates typically range from $24-65 per hour. You can see exact pricing on each caregiver's profile."
    },
    {
      question: "Can I meet the caregiver before booking?",
      answer: "Yes! We encourage families to schedule an initial consultation to meet the caregiver, discuss care needs, and ensure a good match before committing to ongoing care."
    },
    {
      question: "What if I need to cancel or reschedule?",
      answer: "We understand plans change. You can cancel or reschedule up to 24 hours before your appointment without any fees. Last-minute changes may incur a small cancellation fee."
    },
    {
      question: "Is care covered by insurance?",
      answer: "Many insurance plans, including Medicare and Medicaid, may cover certain home healthcare services. We recommend checking with your insurance provider. Many of our agencies also assist with insurance coordination."
    },
    {
      question: "What areas do you serve?",
      answer: "We currently serve Philadelphia, PA; Washington, D.C.; Pittsburgh, PA; and Newark, NJ. We're actively expanding to new areas."
    },
    {
      question: "How do I pay for services?",
      answer: "Payment is processed securely through our platform. We accept all major credit cards and can work with insurance providers for covered services."
    },
  ];
