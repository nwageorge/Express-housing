...
// Grid + Purple Gradient Background Component
const PageBackground = ({ children, className = "" }) => {
  return (
    <div className={`relative min-h-screen w-full ${className}`}>
      ...
      <div className="fixed top-0 left-0 right-0 bottom-0 -z-10 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
      {/* Additional purple accent on right side */}
      <div className="fixed bottom-0 left-0 right-0 top-0 -z-10 bg-[radial-gradient(circle_800px_at_100%_200px,#d5c5ff,transparent)]"></div>
      {/* Content */}
